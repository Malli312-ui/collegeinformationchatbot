...
const prompts = [
  ["hi","hello","hlo","hai"],["college","what is college address","college address","address of college"],["chairman","Chairman"] ,["Principle","principle"],["who is cse hod","cse hod","Cse hod"],["who is ece hod","ece hod","Ece hod"],["canteen","Canteen"],["results"],["College timings","college timings","timings of college"],
...
const replies = [
  ...
  ["Dr. Chodisetty V V S N Murthy,Dr. K Srihari Varma,Smt. K. Vijaya. Lakshmi,Smt. Kanakam Akella,Smt. M. Bhagyalakshmi,Smt. S. Surya Kumari Padala,Kum. V.S.G. Aiswarya,Sri N Rahul Khanna,Smt. Sirisha Meenavalli,Sri M Jahir Khadarir,Sri. K Saibabu,Sri. Gampala Kasiyya,Ms. K. Geethika,Ms. S. Divya,Smt K Anooradha"],["the college has employed qualified and experienced drivers.As there are limited buses/seats transport facility will be provided on first come first serve,"],["As a center of intnse intellectual inquiry, the Library shares with the college the aspiration to be the most dynamic learning environment."],
  ["parking facility available"],["Communication Skills Training,Soft Skills Training,Life Skills,https://idealtech.edu.in/placementcell.php"],["A vast playground with provisions for playing outdoor games like cricket,volleybal,shuttle are in place"],["i am idealcollegechatbot"],["i'm great😊! how can i help you"]
]
